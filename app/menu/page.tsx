              ...
              <div key={item.id} className="group flex flex-col gap-6">
                ...
                {item.image && item.image.url && (
                  <div className="relative p-2 bg-[#111] border border-[#d4af37]/30 shadow-2xl">
                    {/* 四隅の飾り（CSSで実装） */}
                    <div className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-[#d4af37] -translate-x-1 -translate-y-1" />
                    <div className="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-[#d4af37] translate-x-1 -translate-y-1" />
                    <div className="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-[#d4af37] -translate-x-1 translate-x-1" /> {/* translateYのミス修正 */}
                    <div className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-[#d4af37] translate-x-1 translate-y-1" />

                    <div className="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-[#d4af37] -translate-x-1 translate-y-1" /> {/* 修正後 */}
                ...
                <div className="space-y-4 px-2">
                  <div className="flex justify-between items-baseline gap-4">
                    ...
                    <span className="text-lg font-sans text-zinc-400 group-hover:text-[#d4af37] transition-colors">
