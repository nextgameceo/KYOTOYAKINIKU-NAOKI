      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-12 order-2 lg:order-1">
            <section className="space-y-6 bg-white/5 p-10 border border-white/10 shadow-2xl">
              ...
              <dl className="space-y-8 text-sm md:text-base font-sans font-light leading-loose">
                <div>
                  <dt className="text-[#d4af37] text-xs tracking-[0.3em] font-bold mb-3 uppercase font-serif">Address</dt>
                ...
                <div>
                  <dt className="text-[#d4af37] text-xs tracking-[0.3em] font-bold mb-3 uppercase font-serif">Station</dt>
                  <dd className="text-zinc-300">
