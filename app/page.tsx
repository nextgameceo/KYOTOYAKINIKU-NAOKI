    ...
    <div className="bg-[#0a0a0a] text-white overflow-x-hidden">
        ...
        {[
          ...
          >
            ...
            <div className="absolute bottom-6 left-0 right-0 px-3 text-center">
              <p
                className="text-white font-black leading-tight text-sm drop-shadow-lg"
                style={{
      ...
      <section id="concept" className="grid md:grid-cols-2 min-h-screen">
        <div className="relative min-h-[50vh] md:min-h-screen overflow-hidden">
          ...
          <div
            className="absolute right-6 top-1/2 -translate-y-1/2 text-white font-black text-2xl md:text-4xl leading-tight tracking-widest"
      ...
      <section id="kodawari" className="grid md:grid-cols-2 min-h-screen bg-[#0a0a0a]">
        <div className="flex flex-col justify-center px-8 md:px-16 py-20 order-2 md:order-1">
          ...
          <div className="divide-y divide-white/8">
            {[
              ...
              { label: '品質', title: '鮮度を守る品質管理', body: 'どのお客様にも「鮮度がいい」と言っていただけるように、肉の管理・保存を徹底しています。必要な分だけを解凍して使用し、仕入れ直後に丁寧に処理することで、鮮やかな色合いの赤身をお出しします。' },
              ...
              <div key={item.label} className="grid grid-cols-[auto_1fr] gap-5 py-6">
                <span className="text-[#b01020] text-[10px] tracking-widest pt-1" style={{ writingMode: 'vertical-rl' }}>
                  {item.label}
                </span>
                <div>
                  <h3 className="text-base font-bold tracking-wide mb-2" style={{ fontFamily: 'var(--font-noto-serif)' }}>
                    {item.title}
                  </h3>
        ...
        <div className="relative min-h-[50vh] md:min-h-screen overflow-hidden order-1 md:order-2">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
            <p className="text-3xl md:text-5xl font-black text-white leading-snug tracking-wide" style={{ fontFamily: 'var(--font-noto-serif)', textShadow: '0 2px 20px rgba(0,0,0,0.8)' }}>
              心を尽くす
            </p>
      ...
      <section className="py-24 bg-[#080604]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-black tracking-widest mb-4" style={{ fontFamily: 'var(--font-noto-serif)' }}>
              こだわりのタレ
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <div key={tare.name} className="group border-t-2 border-[#b01020] pt-5">
                ...
                <h3 className="text-sm font-bold tracking-wide text-[#c8a84a] mb-2" style={{ fontFamily: 'var(--font-noto-serif)' }}>
                  {tare.name}
                </h3>
      ...
      <section id="menu" className="bg-[#0a0a0a]">
        ...
        {[
          ...
          <div key={i} className={`grid md:grid-cols-2 min-h-[70vh] ${item.bg}`}>
            ...
            <div className={`flex flex-col justify-center px-8 md:px-16 py-16 ${item.reverse ? 'md:order-1' : ''}`}>
              <h3 className="text-3xl md:text-4xl font-bold tracking-widest mb-3" style={{ fontFamily: 'var(--font-noto-serif)' }}>
                {item.name}
              </h3>
        ...
        {menuList.length > 0 && (
          <div className="py-20 bg-[#0a0a0a] border-t border-white/5">
            <div className="max-w-6xl mx-auto px-6">
              <h2 className="text-2xl font-black tracking-widest text-center mb-12 text-[#c8a84a]" style={{ fontFamily: 'var(--font-noto-serif)' }}>
                御品書
              </h2>
        ...
        {[
          ...
          <div key={i} className={`grid md:grid-cols-2 min-h-[60vh] ${i % 2 !== 0 ? 'bg-[#e8e0d0]' : 'bg-[#f0ebe0]'}`}>
            ...
            <div className={`flex flex-col justify-center px-8 md:px-16 py-16 relative ${item.reverse ? 'md:order-1' : ''}`}>
              <div className="absolute right-4 top-1/2 -translate-y-1/2 text-5xl font-black tracking-widest text-black/5 pointer-events-none select-none" style={{ writingMode: 'vertical-rl', fontFamily: 'var(--font-noto-serif)' }}>
                なおき自慢
              </div>
              <span className="inline-block bg-[#b01020] text-white text-[10px] tracking-widest px-3 py-1 mb-5 w-fit">常連さんに愛される</span>
              <h3 className="text-2xl md:text-3xl font-bold tracking-widest mb-2" style={{ fontFamily: 'var(--font-noto-serif)' }}>
                {item.name}
              </h3>
