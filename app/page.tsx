...
import { getNewsList, getShopInfo } from '@/lib/microcms';

export const revalidate = 60;

export default async function HomePage() {
  const [newsRes, shopInfo] = await Promise.all([
    getNewsList(5).catch(() => ({ contents: [] })),
    ...
    <div className="bg-[#0a0a0a] text-white overflow-x-hidden">
      ...
      <section className="relative h-screen flex overflow-hidden">
        ...
        {[
          ...
          <div
            key={i}
            className="relative flex-1 overflow-hidden group transition-[flex] duration-700 ease-in-out hover:flex-[2.5] cursor-pointer"
          >
            <Image
              src={slide.src}
              alt={slide.label}
            ...
            <div className="absolute bottom-6 left-0 right-0 px-3 text-center">
              <p
                className="text-white font-black leading-tight text-sm md:text-base drop-shadow-lg"
                style={{
              ...
              >
                <span className="text-[#c8a84a]">{slide.label}</span>
                <br />
                {slide.sub}
              </p>
            </div>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          <div className="bg-black/40 backdrop-blur-sm px-8 py-6 text-center border border-white/10">
            ...
            <h1
              className="text-5xl md:text-7xl font-black tracking-[0.2em] mb-2"
            ...
            <p className="text-white/60 text-xs tracking-widest hidden md:block">
      ...
      <section id="concept" className="grid md:grid-cols-2 min-h-screen">
        ...
        <div className="relative min-h-[50vh] md:min-h-screen overflow-hidden">
          ...
          <div className="absolute left-6 bottom-8 text-white/70 text-xs tracking-widest">
            18:00〜翌4:00営業
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center px-8 md:px-16 py-20 bg-[#f0ebe0] text-[#1a1208]">
          ...
          <p className="text-sm font-light leading-[2.2] text-[#3a2e22] mb-8">
            名古屋市中区、東新町・女子大エリア。「栄」「新栄町駅」から
            徒歩圏内の「京都焼肉なおき」は、アラカルトやコースで上質な
            肉をリーズナブルにご提供している焼肉屋です。<br /><br />
            朝4時まで営業していますので、一人焼肉やデート、ご宴会、
            女子会などの他、"今日の〆は焼肉"といった贅沢な一日の
            締めくくりにもぜひ。
          </p>
      ...
      <section id="kodawari" className="grid md:grid-cols-2 min-h-screen bg-[#0a0a0a]">
            ...
            {[
              {
                label: 'カット',
                title: '手切りへの徹底',
                body: '肉は一枚一枚すべて手切りしており、もちろん部位によって切り方を変えています。余分な脂は丁寧に取り除き、やわらかい部位は満足感を感じていただけるよう厚めにカット。',
              },
              {
                label: '品質',
                title: '鮮度を守る品質管理',
                body: 'どのお客様にも「鮮度がいい」と言っていただけるように、肉の管理・保存を徹底しています。必要な分だけを解凍して使用し、仕入れ直後に丁寧に処理することで、鮮やかな色合いの赤身をお出しします。',
              },
              {
                label: '想い',
                title: '心を尽くす',
                body: 'それがなおきの美味しさの基準です。素材の力を信じ、丁寧なひと手間を積み重ねることで、一口食べた瞬間に違いがわかる一皿をお届けします。',
              },
            ].map(item => (
              <div key={item.label} className="grid grid-cols-[auto_1fr] gap-5 py-6">
                <span
                  className="text-[#b01020] text-[10px] tracking-widest pt-1"
        ...
        <div className="relative min-h-[50vh] md:min-h-screen overflow-hidden order-1 md:order-2">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
            <p
              className="text-3xl md:text-5xl font-black text-white leading-snug tracking-wide"
              style={{ fontFamily: 'var(--font-noto-serif)', textShadow: '0 2px 20px rgba(0,0,0,0.8)' }}
            >
              心を尽くす
            </p>
            <p className="text-white/60 text-xs tracking-widest mt-2">
              それがなおきの美味しさの基準です。
            </p>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-white/50 text-sm font-light leading-relaxed max-w-md mx-auto">
              タレは、店主の修業元である京都・大韶園と同じものを使用。<br />
              肉の旨みを最大限に引き出す、なおき秘伝の味わいです。
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <div key={tare.name} className="group border-t-2 border-[#b01020] pt-5">
                ...
                <h3
                  className="text-sm font-bold tracking-wide text-[#c8a84a] mb-2"
                  style={{ fontFamily: 'var(--font-noto-serif)' }}
                >
                  {tare.name}
                </h3>
      ...
      <section id="menu" className="bg-[#0a0a0a]">
        ...
        <div className="py-20 text-center border-b border-white/5">
          ...
          <h2
            className="text-5xl md:text-8xl font-black tracking-widest"
            style={{ fontFamily: 'var(--font-noto-serif)' }}
          >
            必食<span className="text-[#b01020]">3</span>選
          </h2>
          <p className="text-white/30 text-xs tracking-widest mt-4">
            ※価格は全て税込みです。
          </p>
        </div>
        ...
        {[
          {
            ...
            name: 'ネギタン塩',
            price: '1,080',
            desc: 'スタッフおすすめの、不動の人気メニューです。食感が硬めの舌先は薄めに、お尻のやわらかい部分は厚めにカット。一皿の中で厚みが異なる肉が楽しめるのも、手切りならでは。',
            note: '※ネギは別添えでお出しします。',
            reverse: false,
            bg: 'bg-[#0d0a05]',
          },
          {
            ...
            name: '赤身3種盛り（塩）',
            price: '2,420',
            desc: 'その日の仕入れによって部位は変わりますが、肉質のやわらかい和牛のみの盛り合わせです。贅沢に厚切りで3種類をお出しします。',
            note: '※写真は左から、和牛カイノミ、和牛ハラミ、和牛フランクです。',
            reverse: true,
            bg: 'bg-[#080604]',
          },
          {
            ...
            name: 'ミノ湯引き',
            price: '980',
            desc: 'てっさをイメージした薄切りのミノは、肉とは思えない食感に驚いていただけること間違いなし。どっさりと乗せたネギをたっぷり巻いてお召し上がりください。',
            note: '',
            reverse: false,
            bg: 'bg-[#0d0a05]',
          },
          ...
          >
            ...
            <div className={`flex flex-col justify-center px-8 md:px-16 py-16 ${item.reverse ? 'md:order-1' : ''}`}>
              ...
              {item.note && (
                <p className="text-xs text-white/35 tracking-wide">{item.note}</p>
              )}
            </div>
          </div>
        ))}
          ...
          <div key={i} className={`grid md:grid-cols-2 min-h-[60vh] ${i % 2 !== 0 ? 'bg-[#e8e0d0]' : 'bg-[#f0ebe0]'}`}>
            <div className={`relative overflow-hidden min-h-[50vw] md:min-h-full ${item.reverse ? 'md:order-2' : ''}`}>
              ...
              <div className="absolute top-4 left-4">
                <span className="bg-[#b01020] text-white text-[10px] tracking-widest px-3 py-1">
                  {item.tag}
                </span>
              </div>
            </div>
            <div className={`flex flex-col justify-center px-8 md:px-16 py-16 relative ${item.reverse ? 'md:order-1' : ''}`}>
              <div
                className="absolute right-4 top-1/2 -translate-y-1/2 text-5xl font-black tracking-widest text-black/5 pointer-events-none select-none"
                style={{ writingMode: 'vertical-rl', fontFamily: 'var(--font-noto-serif)' }}
              >
                なおき自慢
              </div>
              ...
              <p className="text-lg font-semibold tracking-widest text-[#1a1208] mb-6">
                ¥{item.price}
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="border border-white/10 overflow-hidden group hover:border-white/25 transition-colors">
              <div className="relative aspect-video overflow-hidden">
                ...
                <div className="absolute bottom-4 left-5">
                  <span className="bg-[#b01020] text-white text-[10px] tracking-widest px-2 py-1">
                    👤 お一人でも
                  </span>
                </div>
              </div>
              <div className="p-6 bg-white/3">
                ...
                <p className="text-sm font-light leading-relaxed text-white/65 mb-5">
                  塩・タレ・おまかせの他、各種盛り合わせもご用意。お一人で召し上がるのにちょうど良いボリューム感です。
                </p>
            ...
            <div className="border border-white/10 overflow-hidden group hover:border-white/25 transition-colors">
              ...
              <div className="p-6 bg-white/3">
                ...
                <p className="text-sm font-light leading-relaxed text-white/65 mb-5">
                  2名様から貸切OK。飲み放題付きコースで宴会・女子会・各種ご宴席に。詳細はお電話またはWEB予約にてお問い合わせください。
                </p>
      ...
      <section id="kuukan" className="bg-[#080604]">
        ...
        <div className="relative h-[40vh] md:h-[50vh] overflow-hidden">
          ...
          <div
            className="absolute right-8 top-1/2 -translate-y-1/2 text-white font-black text-3xl md:text-5xl tracking-widest"
            style={{
              writingMode: 'vertical-rl',
              fontFamily: 'var(--font-noto-serif)',
              textShadow: '0 2px 20px rgba(0,0,0,0.9)',
          ...
          <div className="grid md:grid-cols-3 gap-6 -mt-8 relative z-10">
            ...
            <div className="border border-white/10 overflow-hidden">
              ...
              <div className="p-5 bg-white/3">
                ...
                <p className="text-xs font-light leading-relaxed text-white/55">
                  4名様向けのテーブル席は2卓あり、仕切りもある適度な間を感じずお食事を楽しめます。7名様までのテーブル席も1卓ご用意しています。
                </p>
              </div>
            </div>
            ...
            <div className="border border-white/10 overflow-hidden">
              ...
              <div className="p-5 bg-white/3">
                ...
                <p className="text-xs font-light leading-relaxed text-white/55">
                  肉を焼く様子を目の前でご覧になれるカウンター席は3席。気になることがあれば遠慮なくお声がけください。
                </p>
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-sm">
                <tbody className="divide-y divide-black/10">
                  {[
                    ...
                    <tr key={label}>
                      <td className="py-3 pr-4 font-semibold text-[#b01020] tracking-widest whitespace-nowrap w-1/4 align-top text-xs">
                        {label}
                      </td>
      ...
      <footer className="bg-[#080604] border-t border-white/6 py-10">
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div
            className="text-[#c8a84a] text-xl font-black tracking-widest"
            style={{ fontFamily: 'var(--font-noto-serif)' }}
          >
            京都焼肉なおき
          </div>
